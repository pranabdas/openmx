...
<img src={require("../static/img/nio-dos.webp").default} className="inv-hue-rot-180" alt="nio-dos"/>
...
details [here](
https://www.openmx-square.org/openmx_man4.0/s16_1_scf-convergence-overview.html).

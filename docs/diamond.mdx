...
<img src={require("../static/img/diamond-band.webp").default} class="inv-hue-rot-180" alt="diamond-band"/>
...
<img src={require("../static/img/diamond-dos.webp").default} class="inv-hue-rot-180" alt="diamond-dos"/>

...
<img src={require("../static/img/convergence-ecut.webp").default} className="inv-hue-rot-180" alt="convergence-ecut"/>
...
<img src={require("../static/img/convergence-kgrid.webp").default} className="inv-hue-rot-180" alt="convergence-kgrid"/>
...
plt.show()
```
<img src={require("../static/img/convergence-alat.webp").default} className="inv-hue-rot-180" alt="convergence-alat"/>
